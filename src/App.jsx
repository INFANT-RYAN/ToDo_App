...
export default function App() {
  ...
  return (
    <div className="mx-auto container flex justify-center items-center   ">
      <div className="md:border-2 bg-white border-[#fca311] md:w-[40%] min-h-screen min-w-full  md:h-96  rounded-lg p-5">
        ...
        <div className="flex justify-center my-5 w-[100%]">
          ...
          />
          <button
            className="  text-[#14213d] font-semibold bg-[#fca311] rounded-md h-10 w-[20%]"
            onClick={addTask}
          >
            ADD
          </button>
